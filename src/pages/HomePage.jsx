...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <section id="platform" className="py-24 bg-gradient-to-b from-[#FFFBF5] to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { icon: <Database className="text-[#8C1D40]" size={32} />, title: 'Data Layer', desc: 'Connects to existing systems' },
              { icon: <Network className="text-[#8C1D40]" size={32} />, title: 'Integration Layer', desc: 'Unified data access' },
              { icon: <Cpu className="text-[#8C1D40]" size={32} />, title: 'Intelligence Layer', desc: 'AI-powered coordination' },
              { icon: <Shield className="text-[#8C1D40]" size={32} />, title: 'Interface Layer', desc: 'Personalized experiences' }
            ].map((layer, index) => (
              <motion.div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div onClick={() => navigate('/platform')} className="cursor-pointer">
              <ProductCard
                icon={<Users className="text-[#8C1D40]" size={40} />}
            ...
            <div onClick={() => navigate('/platform')} className="cursor-pointer">
              <ProductCard
                icon={<Briefcase className="text-[#8C1D40]" size={40} />}
      ...
      <section className="py-24 bg-gradient-to-b from-[#FFFBF5] to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p
            {...fadeInUp}
            className="text-center text-[#8C1D40] italic text-lg"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl font-bold leading-relaxed">
              <span className="text-[#8C1D40]">Every semester of institutional data compounds into intelligence that competitors cannot purchase, replicate, or shortcut.</span>{' '}
      ...
      {/* ==================== SECTION 8: TEAM ==================== */}
      <section id="team" className="py-24 bg-[#FFFBF5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <p className="text-[#8C1D40] font-semibold text-sm">{member.title}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* ==================== SECTION 9: CONTACT ==================== */}
      <section id="contact" className="py-24 bg-gradient-to-b from-[#FFFBF5] to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 text-center">
              ...
              <a href="mailto:partnerships@academicai.solutions" className="text-[#8C1D40] font-semibold hover:underline">
